...
<div>
    <h4 class="mb-4">إضافة موظف جديد</h4>
</div>
...
<div class="row">
    ...
    <div class="col-12">
        <form id="new-user" action="/new-employee" method="POST">
            @csrf
            <!-- بيانات السيارة -->
            <div class="card my-3">
                        ...
                        <div class="row justify-content-start">
                              ...
                              <div class="col-lg-4">
                                <div class="form-group  mx-2 d-block">
                                    ...
                                    <input name="name" type="text" class="form-control text-right" id="exampleInputEmail1" placeholder="الإسم ثلاثى">
                                </div>
                            </div>
                              ...
                              <div class="col-lg-4">
                                <div class="form-group  mx-2 d-block">
                                    ...
                                    <input name="phoneTwo" type="number" class="form-control text-right" id="exampleInputEmail1" placeholder="رقم التليفون أخر">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  mx-2 d-block">
                                    ...
                                    <input name="salary" type="number" class="form-control text-right" id="exampleInputEmail1" placeholder="الراتب">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  mx-2 d-block">
                                    ...
                                    <input name="dateOfJoin" type="date" class="form-control text-right" id="exampleInputEmail1" placeholder="تاريخ التعيين">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  mx-2 d-block">
                                    ...
                                    <input name="username" type="text" class="form-control text-right" id="exampleInputEmail1" placeholder="إسم المسخدم لتسجيل الدخول">
                                </div>
                            </div>
