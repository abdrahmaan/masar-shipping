                            ...
                            <div class="row justify-content-start">
                                ...
                                <div class="col-lg-3 my-1">
                                    <div class="form-group  mx-2 d-block">
                                        ...
                                        <input name="sDate" type="date" class="form-control text-right"
                                ...
                                <div class="col-lg-3 my-1">
                                    <div class="form-group  mx-2 d-block">
                                        ...
                                        <input name="eDate" type="date" class="form-control text-right"
                                            id="exampleInputEmail1" placeholder="رقم الهوية">
                                    </div>
                                </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($Data as $row)
                                <tr>
                                    ...
                                    <td>
                                        <button onclick="displayReason(event)" data-reason='{{ $row->reason }}'
                                            id="btnReason" class="btn btn-primary">سبب الموعد</button>
                                        <button onclick="displayDescription(event)"
                                            data-opdesc='{{ $row->op_description }}' id="btnInfo"
                                            class="btn btn-primary">ملاحظات</button>
                                        @if (in_array('edit-appointment', $permissions))
