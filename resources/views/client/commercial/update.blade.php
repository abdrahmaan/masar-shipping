...
@section('title',"تعديل عميل تجارى")
    

@section('content')

<div>
    <h4 class="mb-4">تعديل عميل تجارى</h4>
</div>
...
<div class="row">
    ...
    <div class="col-12">
        <form id="new-car" action="/edit-commercial-client/{{$Data->id}}" method="POST">
            @csrf

                <!-- بيانات العميل -->
            <div class="card my-3">
                <div class="card-header d-flex align-items-center">   
                    <h3 class="card-title m-0">تعديل بيانات عميل التجارى</h3>
                            ...
                            <!-- الإسم التجارى  -->
                                <div class="col-lg-4 my-1">
                                        <div class="form-group  mx-2 d-block">
                                            ...
                                            <input name="tradeName" value="{{$Data->tradeName}}" type="text" class="form-control text-right" id="exampleInputEmail1" placeholder="الإسم التجارى">
                                        </div>
                                </div>
                            <!-- الإسم ثلاثى  -->
                                <div class="col-lg-4 my-1">
                                        <div class="form-group  mx-2 d-block">
                                            ...
                                            <input name="fullName" value="{{$Data->fullName}}" type="text" class="form-control text-right" id="exampleInputEmail1" placeholder="الإسم ثلاثى ممثل النشاط">
                                        </div>
                                </div>
                                <!-- الجنس -->
                             <div class="col-lg-4 my-1">
                            ...
                            <!-- رقم الضريبي  -->
                                <div class="col-lg-3 my-1">
                                        <div class="form-group  mx-2 d-block">
                                            ...
                                            <input name="taxNumber" value="{{intval($Data->taxNumber)}}" type="number" class="form-control text-right" id="exampleInputEmail1" placeholder="رقم الضريبي">
                                        </div>
                                </div>
                            <!-- رقم السجل التجارى  -->
                                <div class="col-lg-3 my-1">
                                        <div class="form-group  mx-2 d-block">
                                            ...
                                            <input name="registerNumber" value="{{intval($Data->registerNumber)}}" type="number" class="form-control text-right" id="exampleInputEmail1" placeholder="رقم السجل التجارى">
                                        </div>
                                </div>
                            <!-- رقم التليفون  -->
                                <div class="col-lg-3 my-1">
                            ...
                            <!--  2 رقم التليفون  -->
                                <div class="col-lg-3 my-1">
                                        <div class="form-group  mx-2 d-block">
                                            ...
                                            <input name="phoneTwo" value="{{intval($Data->phoneTwo)}}" type="number" class="form-control text-right" id="exampleInputEmail1" placeholder="رقم تليفون أخر">
                                        </div>
                                </div>
