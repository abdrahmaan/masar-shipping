...
<div>
    <h4 class="mb-4">إضافة مندوب جديد</h4>
</div>
...
<div class="row">
    ...
    <div class="col-12">
        <form id="new-car" action="/new-delivery" method="POST">
            @csrf
                        ...
                        <div class="row justify-content-start">
                            ...
                            <div class="col-lg-3 my-1">
                                <div class="form-group  mx-2 d-block">
                                    ...
                                    <input name="commission" type="number" class="form-control text-right" id="exampleInputEmail1" placeholder="0">
                                </div>
                            </div>
                            <!--  إسم المستهدم -->
                            <div class="col-lg-3 my-1">
                                <div class="form-group  mx-2 d-block">
                                    ...
                                    <input name="username" type="text" class="form-control text-right" id="exampleInputEmail1" placeholder="إسم المستخدم لتسجيل الدخول">
                                </div>
                            </div>
