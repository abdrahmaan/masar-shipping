...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12">
            <form id="new-car" action="/terms-conditions" method="GET">
                <!-- بيانات البحث -->
                <div class="card my-3">
                                    ...
                                    <div class="form-group mx-2 d-block">
                                        ...
                                        <select name="contract_type" class="form-control text-right"
                                            ...
                                            <optgroup label="عروض أسعار">
                                                <option value="عرض سعر - توريد وتركيب مصعد">عرض سعر - توريد وتركيب مصعد
                                                </option>
                        ...
                        <tbody>
                            ...
                            @foreach ($Data as $row)
                                <tr>
                                    ...
                                    @endif
                                    <td class="text-center">
                                        @if (in_array('trigger-term-status', $permissions))
                                            @if ($row->status == 'active')
                                                <a href="/terms-conditions/status/{{ $row->id }}"
                                            ...
                                            @endif
                                        @endif
                                        @if (in_array('delete-term', $permissions))
                                            <a href="/delete-terms-conditions/{{ $row->id }}"
