...
@section('title', 'بحث ساسيات الضمان')
...
@section('content')
    ...
    <div>
        <h4 class="mb-4">بحث فى ساسيات الضمان</h4>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <form id="new-car" action="/waranty-policies" method="GET">
                <!-- بيانات البحث -->
                <div class="card my-3">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h3 class="card-title m-0">بيانات ساسيات الضمان</h3>
                </div>
                <!-- /.card-header -->
                        ...
                        <tbody>
                            ...
                            @foreach ($Data as $row)
                                <tr>
                                    ...
                                    @endif
                                    <td class="text-center">
                                        @if (in_array('trigger-waranty-status', $permissions))
                                            @if ($row->status == 'active')
                                                <a href="/waranty-policies/status/{{ $row->id }}"
                                            ...
                                            @endif
                                        @endif
                                        @if (in_array('delete-waranty', $permissions))
                                            <a href="/delete-waranty-policies/{{ $row->id }}"
